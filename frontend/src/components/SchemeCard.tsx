...
export function SchemeCard({ scheme }: { scheme: Scheme }) {
  ...
  return (
    <button
      className={`group relative flex min-h-44 flex-col overflow-hidden rounded-2xl p-6 text-left transition-all duration-150 ease-out hover:-translate-y-0.5 hover:shadow-lift focus-visible:outline-2 focus-visible:outline-brand-orange ${CARD_COLORS[scheme.color]}`}
    >
